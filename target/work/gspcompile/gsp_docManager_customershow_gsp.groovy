...
class gsp_docManager_customershow_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(2)
invokeTag('captureMeta','sitemesh',6,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("layout"),'content':("saturn")],-1)
printHtmlPart(2)
...
printHtmlPart(9)
invokeTag('alert','saturn',19,[:],-1)
printHtmlPart(10)
}
printHtmlPart(10)
invokeTag('render','g',21,['template':("show")],-1)
printHtmlPart(11)
})
...
public static final long LAST_MODIFIED = 1419920233538L
